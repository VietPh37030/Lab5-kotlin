...
fun CategoryApp() {
    val categories = listOf(
        "Fiction", "Mystery", "Science Fiction", "Fantasy", "Adventure",
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        SuggestionChips(suggestions, selectedCategories, onSuggestionSelected = { suggestion ->
        ...
        if (selectedCategories.isNotEmpty()) {
            ...
            SelectedCategoriesChips(selectedCategories, onCategoryRemoved = { category ->
